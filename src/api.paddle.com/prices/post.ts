...
export async function handle(ctx: Context): Promise<Response> {
  ...
  ctx.db
    ...
    .run({
      ...
      unit_price_amount: reqBody.unit_price.amount,
      unit_price_currency_code: reqBody.unit_price.currency_code,
      type: reqBody.type ?? "standard",
      billing_cycle_frequency: reqBody.billing_cycle?.frequency ?? null,
      billing_cycle_intervavl: reqBody.billing_cycle?.interval ?? null,
