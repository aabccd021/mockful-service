    ...
    <html lang="en">
      ...
      <body style="max-width: 30rem">
        ...
        <form method="POST" style="display: flex; flex-direction: column; gap: 1rem;">
          <button style="height: 2rem" name="status" value="paid">Set transaction status to "paid"</button><br>
          <button style="height: 2rem" name="status" value="completed">Set transaction status to "completed"</button><br>
        </form>
      </body>
    </html>
  `;
